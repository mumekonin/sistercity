import {  Controller,  Get,  Post,  Patch,  Param,  Body,  Req,  Query,  UseGuards,  UseInterceptors,  UploadedFile,} from '@nestjs/common';
...
export class MessageController {
  ...
  async uploadAttachment(@UploadedFile() file: Express.Multer.File): Promise<{ fileUrl: string; fileName: string }> {
